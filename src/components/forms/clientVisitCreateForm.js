...
export class ClientVisitCreateForm extends Component {
    ...
    render() {
        const {step} = this.state;
        const {firstName, lastName, pmo, admin, contactNumber, manager, MealsDetails, ScheduleList} = this.state;
        const values = {firstName, lastName, pmo, admin, contactNumber, manager, MealsDetails, ScheduleList};
